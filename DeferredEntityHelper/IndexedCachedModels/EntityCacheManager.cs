...
namespace DeferredEntityHelper.IndexedCachedModels
{
    public class EntityCacheManager
    {
        ...
        public virtual async Task<IDictionary<TKey, TValue>> GetCachedIndexedDictionary<TKey, TValue>(Func<TValue, TKey> indexer) where TValue : class where TKey : notnull
        {
